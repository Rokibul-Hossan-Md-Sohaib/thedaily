...
import image1 from "../../../../image/emergency.jpg"
import "./EmergencyBlog.css"
const EmergencyBlog = () => {
    return (
  ...
  <div className="row mt-5">
      ...
      <div className="col-md-7 align-self-center maintext " >
           <h1 className="">Emergency Issues </h1>
      ...
      <div className="col-md-5 mr-5 mb-5 m-md-0 ">
           <img className="img-fluid image" src={image1} alt="" />
      </div>
